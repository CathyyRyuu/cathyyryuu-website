...
const TAB_DATA = [
  {
    ...
    id: "skills",
    content: (
      <div className="p-4 rounded-xl shadow-md flex flex-col h-60 md:h-48 overflow-y-auto">
        <ul className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 list-disc pl-2">
          <li>Next.js</li>
          <li>Ruby on Rails</li>
          <li>FastAPI</li>
          <li>Django</li>
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center px-4 py-8 xl:gap-16 sm:py-16 xl:px-16">
        <div className="w-full">
          <Image
            ...
            height={500}
          />
          <p className="text-sm text-[#ADB7BE] mt-1 text-center">{`Image is generated by ChatGPT`}</p>
        </div>
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-2xl font-bold text-white mb-4 lg:text-4xl">About Me</h2>
          <p className="text-base lg:text-lg">
            ...
            Let's collaborate for innovative solutions and continuous growth.`}
          </p>
